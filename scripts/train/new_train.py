...
# Dataset Directory
DATASET_DIR = r"D:\projects\Building_sensing\building_construction_year\Mask_RCNN_TF_2.10\data\main_datasets\example_train_data"
...
# save model
model_path = os.path.join(ROOT_DIR, "weights", "new", "maskrcnn_tuned_on_coco_1.h5")
